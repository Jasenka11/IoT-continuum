...
#if defined( WIFI_Kit_32_V3 ) || defined( WIFI_Kit_32 ) || defined( WIFI_LoRa_32 ) || defined( WIFI_LoRa_32_V2 )
...
Heltec_ESP32::~Heltec_ESP32(){
#if defined( WIFI_Kit_32_V3 ) || defined( WIFI_Kit_32 ) || defined( WIFI_LoRa_32 ) || defined( WIFI_LoRa_32_V2 ) || defined( Wireless_Stick )
	delete display;
#endif
}
...
#if defined( WIFI_LoRa_32_V2 ) || defined( Wireless_Stick ) || defined( Wireless_Stick_Lite ) || defined(WIFI_Kit_32_V3) || defined(WIFI_Kit_32) || defined( Wireless_Bridge )
